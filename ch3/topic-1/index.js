/* importing module in backend (server) is using require, it is different to frontend that use import from in this case, we use fs, to read and write file in the backend (server)side */
